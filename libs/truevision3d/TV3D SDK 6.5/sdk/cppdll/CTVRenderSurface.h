...
public:
	...
	int CreateStaticTextureFromRenderSurface(int iWidth, int iHeight, int iColorKey = 0, char* sName= NULL);
	int CreateStaticCubeMapFromRenderSurface(int iColorKey = 0, const char* sName= NULL);
	...
	void SetSystemMemCopy(bool bEnable);
