...
typedef struct cTV_4DVECTOR
{
	...
	float x,y,z,w; // note w is after all 
...
typedef struct cTV_VERTEXELEMENT
{
    ...
    typedef enum cCONST_TV_PARTICLEUPDATE {
        cTV_UPDATE_ACTIVE = 0,
        cTV_UPDATE_NON_ACTIVE = 1,
        cTV_UPDATE_BOTH = 2,
        cTV_UPDATE_GENERATOR = 4,
        cTV_UPDATE_RANDOM_GENERATOR = 8,
        cTV_UPDATE_FOLLOW_LANDSCAPE = 16,
        cTV_UPDATE_BOUNCE_ON_LANDSCAPE = 32,
        cTV_UPDATE_BOUNCE_ON_Y0_PLANE = 64,
        cTV_UPDATE_BOUNCE_ON_CUSTOM_PLANE = 128
    } cCONST_TV_PARTICLEUPDATE;
    ...
    typedef enum cCONST_TV_JOYSTICK_DATAFORMAT {
        cTV_DIJoyStick1 = 3,
        cTV_DIJoyStick2 = 4
    } cCONST_TV_JOYSTICK_DATAFORMAT;
    ...
    typedef enum cCONST_TV_TEXT_DIRECTION {
        cTV_TEXT_DIRECTION_LEFTRIGHT = 1,
        cTV_TEXT_DIRECTION_RIGHTLEFT = 2,
        cTV_TEXT_DIRECTION_UPDOWN = 3,
        cTV_TEXT_DIRECTION_DOWNUP = 4
    } cCONST_TV_TEXT_DIRECTION;

    typedef enum cCONST_TV_TILEMAP_COLLISION {
        cTV_TILEMAP_COLLISION_TOP = 2,
        cTV_TILEMAP_COLLISION_BOTTOM = 4,
        cTV_TILEMAP_COLLISION_LEFT = 8,
        cTV_TILEMAP_COLLISION_RIGHT = 16,
        cTV_TILEMAP_COLLISION_TOPLEFT_BOTTOMRIGHT = 32,
        cTV_TILEMAP_COLLISION_BOTTOMLEFT_TOPRIGHT = 64
    } cCONST_TV_TILEMAP_COLLISION;

    typedef enum cCONST_TV_FLIP {
        cTV_FLIP_NONE = 0,
        cTV_FLIP_X = 1,
        cTV_FLIP_Y = 2,
        cTV_FLIP_XY = 3
    ...
    typedef struct cTV_TILEMAP_TILE {   
        long PartId;        
        long Flip;   
        long Collision;
        long User;
	...
	{
		cTV_PARTICLE_KEYUSAGE_QUATERNION = 1,
