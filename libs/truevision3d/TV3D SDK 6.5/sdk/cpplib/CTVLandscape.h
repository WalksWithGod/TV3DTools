...
public:
	...
	bool GenerateTerrain(const char* sDataSource, cCONST_TV_LANDSCAPE_PRECISION ePrecision, int iWidth,int iHeight, float fPosX, float fPosY, float fPosZ, bool bSmoothTerrain = true);
	...
	// splatting support.
	void SetSplattingEnable(bool bEnable, int iChunk = -1);
