...
public:
	...
	void SetPathSpeed(float fSpeed, float fDelta);
	...
	void SetViewIsometric(float fZoom, float fFarPlane);
	...
	void ChaseCameraMatrix(cTV_3DMATRIX* sMatrix, cTV_3DVECTOR* vRelativeEndPosition, cTV_3DVECTOR* vLookAtInMesh, float fCameraSpeed, bool bProgressiveSpeed = true, float fMaxSpeed = -1.0f  , float fMinSpeed =-1.0f, bool bUseTimeElapsed = true);
	void ChaseCamera(CTVMesh* pMesh ,cTV_3DVECTOR* vRelativeEndPosition, cTV_3DVECTOR* vLookAtInMesh, float fCameraSpeed, bool bProgressiveSpeed = true, float fMaxSpeed =-1.0f , float fMinSpeed = -1.0f,  bool bUseTimeElapsed = true);
	void ChaseCameraActor(CTVActor* pActor ,cTV_3DVECTOR* vRelativeEndPosition, cTV_3DVECTOR* vLookAtInMesh, float fCameraSpeed, bool bProgressiveSpeed = true, float fMaxSpeed = -1.0f , float fMinSpeed =-1.0f, bool bUseTimeElapsed = true);
	...
	void OccQuery_DrawBox(cTV_3DVECTOR* vBoxMin, cTV_3DVECTOR* vBoxMax);
	void OccQuery_DrawBoxEx(cTV_3DVECTOR* vBoxMin, cTV_3DVECTOR* vBoxMax, cTV_3DMATRIX* mMatrix);
	void OccQuery_DrawQuad(cTV_3DVECTOR* vVector1, cTV_3DVECTOR* vVector2, cTV_3DVECTOR* vVector3, cTV_3DVECTOR* vVector4);
	void Destroy();
